...
public class CommentTranslator {
  ...
  public static Map<DocumentedExecutable, EqOperationSpecification> mapExecutablesToCrossOracles(
    ...
    for (DocumentedExecutable member : members) {
      ...
      List<EquivalentMatch> equivalentMatches =
          CommentTranslator.translateEq(documentedType, member);
  ...
  public static Map<DocumentedExecutable, List<TemporalMatch>> translateTemporalMatchesFor(
      DocumentedType documentedType) {
    List<DocumentedExecutable> members = documentedType.getDocumentedExecutables();
    ...
    for (DocumentedExecutable member : members) {
      List<TemporalMatch> temporalMatches =
          CommentTranslator.translateTP(tempProtocolMatcher, member);
  ...
  public static Map<DocumentedExecutable, ProtocolSpecification> mapExecutablesToProtocolSpecs(
    ...
    for (DocumentedExecutable member : members) {
      ...
      List<ProtocolSpec> protocolSpecifications =
          createProtocolSpecifications(member, temporalMatches);
  ...
  private static List<ProtocolSpec> createProtocolSpecifications(
    ...
    for (TemporalMatch tm : temporalMatches) {
      ...
      postAssertion =
          new PostAssertion(
              new Body(new LinkedList<>()), new Assertion(assertion), new Body(new LinkedList<>()));

      protocolSpecs.add(
          new ProtocolSpec(
              member.getFreeText().getComment().getText(), new Guard("", "true"), postAssertion));
    }
  ...
  /**
   * Replace "args" identifiers in specifications generated by CallMeMaybe with the actual parameter
