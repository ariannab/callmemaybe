...
/**
 * Stores signatures (extracted from comments) and their correct args filling (according to the comment).
 */
public class DocSignatureParameters {
    ...
    public DocSignatureParameters(String singleSignature, List<DocumentedParameter> documentedParameters){
