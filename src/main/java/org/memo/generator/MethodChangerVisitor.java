...
public class MethodChangerVisitor
  ...
  /** Holds MeMo configuration options. */
  private final Configuration conf = MeMo.configuration;
  ...
  private void getExpectedExceptionChanger(
    ...
    for (ThrowsCondition throwsSpecification : operationSpec.getThrowsConditions()) {
      ...
      // boolean condition generated by MeMo. For example, suppose that the first argument
      // of a method is null, and that MeMo generates a condition like
      ...
      // code that has been translated by MeMo in the commented boolean condition.
